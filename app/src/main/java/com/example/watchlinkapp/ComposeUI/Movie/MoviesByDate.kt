...
fun MoviesByDate(
    ...
    val releaseYearListUiState = viewModel.releaseYearListUiState.collectAsState(initial = ReleaseYearRemote())
    ...
    val buttonText = if (releaseYearList.isNotEmpty()) {
        ...
        "Год не выбран" // Значение по умолчанию, если список пуст
    }
    ...
    Column {
        Column(modifier = Modifier.fillMaxWidth().padding(start = 20.dp, end = 20.dp, bottom = 10.dp),
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Button(modifier = Modifier.fillMaxWidth(), shape = RoundedCornerShape(5.dp), onClick = { expandedEndDate = true }) {
